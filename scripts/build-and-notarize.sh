...
# --- Constants ---
SCHEME="ModelForge (Release)"
APP_NAME="ModelForge"
KEYCHAIN_PROFILE="notary"
SPARKLE_VERSION="2.9.1"
GITHUB_REPO="memfrag/ModelForge"
...
# MARKETING_VERSION in the project file is the single source of truth for the version.
CURRENT_VERSION=$(grep -m1 'MARKETING_VERSION' "$PBXPROJ" | sed 's/.*= *//;s/ *;.*//' || true)
[ -n "$CURRENT_VERSION" ] || error "Could not read MARKETING_VERSION from $PBXPROJ."
